...
export default function EmployeeManagement({ setAddModalOpen }) {
    ...
    const getallReports = async () => {
        ...
        try {
            const { data } = await axios.get(
                "https://employee-performance-report-backend.onrender.com/api/performance/reports"
            );
    ...
    const handleDepartment = async (event) => {
        ...
        try {
            const { data } = await axios.get(
                `https://employee-performance-report-backend.onrender.com/api/performance/reports/department/${event.target.value}`
            );
            setReports(data.report);
    ...
    const handleRole = async (e) => {
        ...
        try {
            const { data } = await axios.get(
                `https://employee-performance-report-backend.onrender.com/api/performance/reports/role/${e.target.value}`
            );
            setReports(data.report);
    ...
    return (
        <Card>
            ...
            {/* Table */}
            {reports.length == 0 ? (
                <Typography my={"2rem"} textAlign={"center"}>
                    {" "}
                    No Report Found{" "}
                </Typography>
            ) : (
                                        ...
                                        <TableCell>
                                            <Typography
                                                ...
                                                sx={{
                                                    fontSize: "18px",
                                                    color:
                                                        rep?.clientFeedback.rating == "Good"
                                                            ? "success.main"
                                                            : "error.main",
                                                }}
                                            >{rep?.clientFeedback.rating}</Typography>
                                        </TableCell>
